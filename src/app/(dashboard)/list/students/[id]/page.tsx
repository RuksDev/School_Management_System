        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="bg-ruksSkyBlue py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <h1 className="text-xl font-semibold">Emma Brown</h1>
              <p className="text-sm text-gray-500">
                Hi, I&apos;m Emma Brown! I&apos;m a 10th grader in class 10A. I
                love learning new things and making friends. I enjoy
                participating in class activities and always try to bring a
                positive attitude. When I&apos;m not studying, I like exploring
                new ideas and having fun with my friends.
              </p>
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 rounded-md gap-4 w-full flex md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              />
              <div className="">
                <h1 className="text-xl font-semibold">10A</h1>
