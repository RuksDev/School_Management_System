    ...
    <td>
      <div className="flex items-center gap-2">
        <Link href={`/list/teachers/${item.id}`}>
          <button className="w-7 h-7 flex items-center justify-center rounded-full bg-ruksSkyBlue hover:scale-105 transition-transform duration-200 ease-in-out hover:shadow-md">
